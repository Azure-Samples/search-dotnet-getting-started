...
(function ($) {
    ...
    // modified: renamed autocomplete to autocompleteInline to make it work side by side with jQuery UI autocomplete plugin
	$.fn.autocompleteInline = function(_options, _second, _third){
